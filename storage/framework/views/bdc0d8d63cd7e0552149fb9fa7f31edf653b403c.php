                                            ...
                                            <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <input type="text" id="numf"  name="numero" class="form-control numf">   
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <label for="">N° BC</label>
                                                        <input type="text" id="numbc"  class="form-control" name="numerobc">   
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <label for="">N° Convention</label>
                                                        <input type="text" id="numbc"  class="form-control" name="convention">   
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="type" id="tva" value="tva" > Tva
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="type" id="timbre" value="timbre"> Timbre
                                                            </label>
                                                        </div>   
                                                    </div>
                                                </div>
