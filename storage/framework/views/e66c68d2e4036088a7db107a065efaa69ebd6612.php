                                ...
                                <div class="card mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="leftSide"><!-- Begin of content -->
                                            <form  id="Factureform" action="<?php echo e(route('facture.update',['facture'=>$facture->id])); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                ...
                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-group" id="dynamic_form<?php echo e($key); ?>">
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                <input type="text" value="<?php echo e($item->designation); ?>" name="dynamic_form[dynamic_form][<?php echo e($key); ?>][designation]"  id="p_name" placeholder="désignation" class="form-control">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="number" class="form-control" value="<?php echo e($item->quantite); ?>" name="dynamic_form[dynamic_form][<?php echo e($key); ?>][quantite]"  id="quantite" placeholder="Quantité" >
                                                            </div>

                                                            <div class="col-md-2">
                                                                <input type="number" class="form-control" value="<?php echo e($item->prix); ?>" name="dynamic_form[dynamic_form][<?php echo e($key); ?>][prix]"  id="prix" placeholder="Prix" >
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="number" class="form-control" value="<?php echo e($item->prix*$item->quantite); ?>" readonly name="dynamic_form[dynamic_form][<?php echo e($key); ?>][montant]"  id="montant" placeholder="montant" >
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <ul class="list-group">
                                                        <li class="list-group-item">TOTAL HT :<span id="total"><?php echo e($facture->total); ?></span> </li>
                                                        <li class="list-group-item">TVA : <span id="tva"><?php echo e($facture->total*0.19); ?></span> </li>
                                                        <li class="list-group-item">Timbre : <span id="timbre">10</span> </li>
                                                        <li class="list-group-item">Total TTC : <span id="ttc"><?php echo e($facture->total+($facture->total*0.19)); ?></span> </li>
                                                    </ul>
                                                </div>
                                                <br>
