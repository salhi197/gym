...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(../mart/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <?php if(isset($url)): ?>
                            <form class="mt-4" method="POST" action='<?php echo e(url("login/$url")); ?>' aria-label="<?php echo e(__('Login')); ?>">
                        <?php else: ?>
                            <form class="mt-4" method="POST" action="<?php echo e(route('login')); ?>" aria-label="<?php echo e(__('Login')); ?>">
                        <?php endif; ?>
                            <?php echo csrf_field(); ?>
