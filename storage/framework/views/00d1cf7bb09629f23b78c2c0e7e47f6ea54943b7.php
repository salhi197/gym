                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card mt-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  action="<?php echo e(route('stock.update',['stock'=>$stock->id])); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                            <div class="container-fluid">
                                                    <div class="well sm">
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                ...
                                                                <label for="">Produit :</label>
                                                                    <select class="form-control " id="" value="<?php echo e($stock->produit); ?>" name="produit">
                                                                        ...
                                                                        <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            ><?php echo e($produit->designation); ?></option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="fournisseur" value="<?php echo e($stock->fournisseur); ?>" name="fournisseur">
                                                                </div>
                                                            </div> 
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <label for="">Quantité</label>
                                                                    <input type="text" class="form-control" id="quantite" value="<?php echo e($stock->quantite); ?>" name="quantite">
                                                                </div>
                                                            </div> 
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    <label> prix d'achat</label>
                                                                    <input type="text" value="<?php echo e($stock->prix); ?>" name="prix" id="prix" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="well">
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <label>Date :</label>
                                                                    <input type="date" value="<?php echo e($stock->date_stock); ?>" name="date_stock" id="date_stock" class="form-control mesdates">
                                                                </div>
                                                            </div>
