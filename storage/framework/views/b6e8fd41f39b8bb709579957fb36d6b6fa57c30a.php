            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-small-cap"><span class="hide-menu text-white">Applications</span></li>

                        <li class="sidebar-item"> 
                            <a class="sidebar-link text-white" href="<?php echo e(route('client.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> 
                            ...
                            <i class="fas fa-user-plus"></i>
                                <span class="hide-menu">Opérateur</span>
                            </a>
                        </li>

                        <li class="sidebar-item"> 
                            <a class="sidebar-link text-white" href="<?php echo e(route('analyse.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> 
                            <a class="sidebar-link text-white" href="<?php echo e(route('produit.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> 
                            <a class="sidebar-link text-white" href="<?php echo e(route('facture.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> 
                            <a class="sidebar-link text-white" href="#" aria-expanded="false">
                            <i class="fa fa-wallet"></i>
                            <span class="hide-menu">Dépense</span>
                            </a>
                        </li>


                        <li class="sidebar-item"> 
                            <a class="sidebar-link text-white" href="<?php echo e(route('stock.index')); ?>" aria-expanded="false">
