                                            ...
                                            @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <input type="text" id="numf"  value="{{old('numero')}}" name="numero" class="form-control numf">   
                                                    </div>
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <input type="text" id="numbc"  class="form-control" value="{{old('convention')}}" name="convention">   
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <div class="checkbox">
                                                            <label>
