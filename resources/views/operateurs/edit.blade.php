                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" value="{{$operateur->role}}" name="role">
                                                            ...
                                                            <option value="Utilisateur" @if($operateur->role == "Utilisateur") selected @endif>Utilisateur</option>
                                                            <option value="ChargeSortie" @if($operateur->role == "ChargeSortie") selected @endif>Chargé de Sortie</option>
                                                        </select>
                                                    </div> 
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="type">
                                                            <option value="1" @if($operateur->type ==1) selected @endif>micro biologie</option>
                                                            <option value="2" @if($operateur->type ==2) selected @endif>physico chimique</option>
                                                        </select>
                                                    </div> 
                                                </div>
