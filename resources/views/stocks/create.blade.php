                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                ...
                                                                <label for="">Produit :</label>
                                                                    <select class="form-control " id="" value="{{old('produit')}}" name="produit">
                                                    ...
                                                    <div class="well">
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    <label>Date :</label>
                                                                    <input type="date" value="{{old('date_stock')}}" name="date_stock" id="date_stock" class="form-control mesdates">
                                                                </div>
                                                            </div>
