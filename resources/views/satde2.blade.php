                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="{{asset('mart/assets/images/users/profile-pic.jpg')}}" alt="user" class="rounded-circle"
                                    width="40">
...
<div id="fullCalModal" class="modal fade">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="{{route('reservation.store')}}" >
                            @csrf
                            <input type="hidden" readonly class="form-control" value="2"  name="stade" placeholder="Enter email">
    ...
    <script src="{{asset('mart/dist/js/pages/calendar/cal-init2.js')}}"></script>
</body>
