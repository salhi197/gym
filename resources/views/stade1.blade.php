...
<div id="fullCalModal" class="modal fade">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="{{route('reservation.store')}}" >
                            @csrf
                            <input type="hidden" readonly class="form-control" value="1" name="stade" placeholder="Enter email">
    ...
    <script src="{{asset('mart/dist/js/pages/calendar/cal-init1.js')}}"></script>
</body>
